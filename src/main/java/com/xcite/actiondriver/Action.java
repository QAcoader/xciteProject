package com.xcite.actiondriver;
...
public class Action extends BaseClass {
	...
	public boolean type(WebElement ele, WebElement username) {
		boolean flag = false;
		try {
	...
	public void click1(ThreadLocal<RemoteWebDriver> driver, WebElement searchProductBox) {
